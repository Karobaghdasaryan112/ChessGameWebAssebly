using System;
using static ServerSideClientUI.ServiceEndpoints.Actions;
using static ServerSideClientUI.ServiceEndpoints.Endpoints;
...
namespace ServerSideClientUI.ServiceEndpoints
{
    public static class BasePaths
    {
        ...
        /// </summary>
        internal static readonly string baseUrlHub = "http://localhost:5203/gameHub";
